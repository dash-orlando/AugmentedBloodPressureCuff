...
class m_logger(object):
    #def change(self,var):
        #self.var=var
    def __init__(self,log_dir="blogs",log_recs=1000,number_logs=0):
        ...
        self.flush_time=120 #flush logs to disk every 2 minutes
    def __flushlogs(self): # write to disk every five minutes
        self.fo.flush()
    ...
    def log_data(self, data):
        ...
        try:
            ...
            if self.flush_flag and time.time()>self.timenow+self.flush_time: ##check to flush data every five minute
                self.__flushlogs()
