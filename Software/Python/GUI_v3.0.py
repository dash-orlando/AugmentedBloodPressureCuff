...
# ------------------------------------------------------------------------
    ...
    def main( self ):
        ...
        self.app = gui( "SBPCUFF MQTT TEST v0.2.7" )                    # Create GUI variable
...
# ------------------------------------------------------------------------
    ...
    def MQTTwindow(self, startButton_input):
            ...
            if (startButton_input == "Start"):
                ...
                self.app.setSize( self.resWidth/4-7*self.pad, self.resHeight-4*self.pad)
                self.app.setLocation( (3*self.resWidth)/4, 0 )
                self.app.setFont(size=36)
