...
void loop()
{
  ...
  /* Append to string conditionally.
     If the proximity of the stethoscope (magnet) is acceptable, prepare to publish an OK. */
  ...
  /* Append to string conditionally.
   *  If the orientation is acceptable, prepare to publish an OK. */
  ...
  /* Delay to give MQTT time to catch up:
     Value of about 200ms to 250ms is sufficient to maintain near real-time throughput to screen via Chatterbox.
  */
  delay(500);
};
